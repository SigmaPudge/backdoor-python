...
# while True:
#     try:
#         command = s.recv(1024**2).decode("cp866")
#         if command == "/sendfile":
#             print(1)
#             s.send(b"got_it")
#             print(2)
#             filename = s.recv(1024**2).decode("cp866")
#             print(3)
#             s.send(b"got_it")
#             print(4)
#             try:
...
#                 print(6)
#                 s.send(f"[+] file: {filename} has been uploaded [+]".encode("cp866"))
#             except:
#                 s.send(f"[!] file: {filename} has been not uploaded [!]".encode("cp866"))
#         else:
